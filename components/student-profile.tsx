    ...
    <div className="student-profile-shell">
      ...
      <main className="student-profile-page">
        ...
        <section className="student-profile-overview">
          <article className="student-main-progress"><div><small>Progresso atual</small><strong>{study.progress}%</strong><p>{study.currentSubject || "Nenhum assunto registrado ainda."}</p></div><div className="student-progress-track"><span style={{ width: `${Math.min(100, study.progress)}%` }} /></div></article>
